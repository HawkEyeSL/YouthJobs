...
DATABASES = {
    'default': {
        ...
        'NAME': 'youthjobsdb',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'sy#c4uhjobrer325kmcgr-xpb=(8g=w8cq3twq7$3rje4&-tnu'
...
ROOT_URLCONF = 'youthjob.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'youthjob.wsgi.application'
